...
function initstart() {
    ...
    var geometry = new THREE.CylinderGeometry(1.4, 1.4, 12, 8);
    var material = new THREE.MeshStandardMaterial({ color: 0xf6317b, metalness: 0, roughness: 1, envMapIntensity: 1.0 });
    cylinder = new THREE.Mesh(geometry, material);
    cylinder.rotation.set(Math.PI * .5, 0, 0);
    scene.add(cylinder);
    var geometry = new THREE.CylinderGeometry(1.0, 1.2, 1, 8);
    var material = new THREE.MeshStandardMaterial({ color: 0x5935bc, metalness: 0, roughness: 1, envMapIntensity: 1.0 });
    cylinder2 = new THREE.Mesh(geometry, material);
    cylinder2.rotation.set(Math.PI * .5, 0, 0);
    scene.add(cylinder2);
    var geometry = new THREE.CylinderGeometry(0.8, 0.8, 3, 8);
    cylinder3 = new THREE.Mesh(geometry, material);
    cylinder3.rotation.set(Math.PI * .5, 0, 0);
    scene.add(cylinder3);
    cylinder2.position.set(-15.0, -26.5, -185);
    cylinder.position.set(-15.0, -26.5, -192);
    cylinder3.position.set(-15.0, -26.5, -199);
    mFbx_Boy.add(cylinder);
    mFbx_Boy.add(cylinder2);
    mFbx_Boy.add(cylinder3);
    scene.add(mFbx_Boy);
