...
function createColor(i) {
	var frequency = mColorRun.colordiff;
...
function createPlan(tex, width, hight, trans) {
	var material = new THREE.MeshBasicMaterial({ map: dropTex });
...
function createPlanMesh() {
	var material = new THREE.MeshBasicMaterial({ map: dropTex , transparent: true,blending:THREE.CustomBlending,blendSrc:THREE.OneFactor,blendDst:THREE.OneMinusSrcAlphaFactor});
...
function createPlayer() {
	var material = new THREE.MeshBasicMaterial({ map: cupTex , transparent: true,blending:THREE.CustomBlending,blendSrc:THREE.OneFactor,blendDst:THREE.OneMinusSrcAlphaFactor});
	// var material = new THREE.MeshBasicMaterial({ map: cupTex , transparent: true});
