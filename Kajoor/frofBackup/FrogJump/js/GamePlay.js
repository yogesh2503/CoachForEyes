...
function DrawScene() {
    DrawTexture(mTex_BG[mGameMode], BG1, 0);
    DrawTexture(mTex_BG[mGameMode], BG2, 0);


    DrawTexture(mTex_Wave[mGameMode], BGWave[0], 0);
    DrawTexture(mTex_Wave[mGameMode], BGWave[1], 0);
}
